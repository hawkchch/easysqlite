...
#easySQLite module build
echo "------------------- Building easySQLite for ANDROID platform ---------------"
pushd `pwd`
mkdir -p ./../../../build/android/easySQLite
...
echo "-------- Installing easySQLite libs -----"
cp -r ./obj/local/armeabi/lib* ./../../../build/android/easySQLite/
